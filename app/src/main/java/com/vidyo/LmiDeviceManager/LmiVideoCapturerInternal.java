...
*/
	...
	public void surfaceCreated(SurfaceHolder holder) {
		...
		try {
            // restart camera, if is Android N version and application open from background
        if (Build.VERSION.SDK_INT >= 24) {
            start(savedFormat, savedWidth, savedHeight, savedFrameRate);
            //TODO: Use JobScheduler for handle application in background for Android API >= 24 correctly
        }
