...
public class LmiAndroidJniConferenceCallbacks extends LmiAndroidJniCallback implements Serializable {
	...
	/**
	 * This string identifies the Lecture Mode state. The values defined below "JNI_LECTUREMODE_STATE"
	 * identify the possible states returned.
	 *
	 * void mConferenceLectureModeStateCallback(int state)
	 * where:
	 *   state : identifies the lecture mode state
	 */
	String mConferenceLectureModeStateCallback;
	
	/**
	 * This string identifies the Lecture Mode Hand Cleared callback. This callback is called when
	 * Lecture Mode Hand cleared event is received
	 *
	 * void mConferenceLectureHandClearedCallback()
	 */
	String mConferenceLectureHandClearedCallback;
	
	/**
	 * This string identifies the Lecture Mode Presenter Changed callback method. This method
	 * will be called with the URI of the new presenter.
	 *
	 * void mConferenceLecturePresenterChangedCallback(String uri)
	 * where:
	 *   name : string name of the camera switched to
	 */
	...
	public LmiAndroidJniConferenceCallbacks() {
		...
		mConferenceLectureModeStateCallback = "";
		mConferenceLectureHandClearedCallback = "";
		mConferenceLecturePresenterChangedCallback = "";
	}
	...
	public void LmiAndroidJniConferenceLectureModeCallbacks(Object object, String lectureStateCallback, String lectureHandClearedCallback,
		   String lecturePresenterChangedCallback ) {
		mConferenceLectureModeStateCallback = lectureStateCallback;
		mConferenceLectureHandClearedCallback = lectureHandClearedCallback;
		mConferenceLecturePresenterChangedCallback = lecturePresenterChangedCallback;
	}
	...
	public String getConferenceLectureModeStateCallback() {
		return mConferenceLectureModeStateCallback;
	}
	public String getConferenceLectureHandClearedCallback() {
		return mConferenceLectureHandClearedCallback;
	}
	public String getConferenceLecturePresenterChangedCallback() {
		return mConferenceLecturePresenterChangedCallback;
	}
