...
public class LmiAndroidJniMessageCallbacks extends LmiAndroidJniCallback implements Serializable {
	 ...
	 */
	public LmiAndroidJniMessageCallbacks(Object object, String messageOutMsgCallback, String messageOutMsgIdCallback) {
		super(object);
		mMessageOutMsgCallback = messageOutMsgCallback;
		mMessageOutMsgIdCallback = messageOutMsgIdCallback;
	}
	...
	public String getMessageOutMsgIdCallback() {
		return mMessageOutMsgIdCallback;
	}
}
