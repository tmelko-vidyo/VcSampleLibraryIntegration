...
public class LmiAndroidAppJni extends android.app.Application {
	 ...
	 * @return
	 */
	public native long LmiAndroidJniConstruct(String caFileName, String MachineID, String androidConfigDirName, 
		String androidLogDirName, String installedDirName, 
		String versionName, Activity activity);
	...
	public native void LmiAndroidJniLoginWeb(SamlEntity samlEntity);

	public native void LmiAndroidJniGetLoginType(String portal);
	...
	/**
	 * This method is called to setup annotation such as "(Guest)" to append to name label
	 * @param tag
	 */
	public native boolean LmiAndroidJniSetGuestTag(String tag);
	 ...
	 * @param callbacks
	 */
	public native void LmiAndroidJniLectureRaiseHand(boolean raise);
